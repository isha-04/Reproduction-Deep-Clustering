"""
Code to create the AlexNet model
"""
...
class AlexNet(nn.Module):
    ...
    def forward(self, x):
        """
        Forward layer of the Alexnet model
        """
    ...
    def _initialize_weights(self):
        """
        Initialize the weights of the Alexnet model
        """
...
def alexnet(sobel=False, bn=True, out=1000):
    """
    Function to call the Alexnet model
    """
    dim = 2 + int(not sobel)
    model = AlexNet(make_layers_features(CFG['2012'], dim, bn=bn), out, sobel)
    print("In alexnet_model model created")
    return model